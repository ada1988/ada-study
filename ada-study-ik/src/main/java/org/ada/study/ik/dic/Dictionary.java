...
import org.ada.study.ik.conf.Configuration;
...
public class Dictionary {
	...
	private void loadMainDict(){
		...
		InputStream is = null;
		try {
			is = Files.newInputStream( Paths.get(new URI( cfg.getMainDictionary() )), StandardOpenOption.READ );
