	...
	public static void main(String[] args) {
		...
		new Thread( new Runnable() {
			...
			public void run() {
				...
				Integer count = new ForkJoinPool().invoke(new Region2Test(funds,"thread-main-1",3));
		...
		new Thread( new Runnable() {
			...
			public void run() {
				...
				Integer count = new ForkJoinPool().invoke(new RegionTest(funds2,"thread-main-2",8));
				System.out.println("开启任务个数："+count);
			}
		} ).start();
